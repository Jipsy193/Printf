...
/**
 * print_octal - Prints an unsigned octal notation
 ...
 */
int print_octal(va_list arg_types, char buffer[],
int flags, int width, int precision, int size)
{
int i = BUFFER_SIZE - 2;
unsigned long int num = va_arg(arg_types, unsigned long int);
...
/**
 * print_hexadecimal - Prints an unsigned hexadecimal notation
 * @arg_types: Listof arguments
 * @buffer: handle print
 * @flags:  Calculates active flags
 * @width: get width
 * @precision: Precision specification
 ...
 * Return: length of chars printed
 */
int print_hexadecimal(va_list arg_types, char buffer[],
int flags, int width, int precision, int size)
{
