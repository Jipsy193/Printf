#include "main.h"
/*
 * PRINT CHAR - function to print char
 ...
 */
int print_string(va_list arg_types, char buffer[],
int flags, int width, int precision, int size)
{
int length = 0, i;
 ...
 */
int print_binary(va_list arg_types, char buffer[],
int flags, int width, int precision, int size)
{
